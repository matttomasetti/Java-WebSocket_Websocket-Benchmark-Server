# Java Websocket Benchmark Server
...
This is a Java (WebSocket) variation of websocket servers designed to 
...
## Quick Set-Up
```
docker run -p 8080:8080 mtomasetti/java-websocket_websocket-benchmark-server
```
That's it! The websocket server will automatically start on **port 8080**

## Dockerfile Set-Up
```
docker build . -t websocket_benchmark/java
docker run -p 8080:8080 websocket_benchmark/java
```
